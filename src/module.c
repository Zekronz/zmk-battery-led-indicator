...
BUILD_ASSERT(DT_NODE_EXISTS(DT_NODELABEL(charge_status)), "Node 'charge_status' not found.");
BUILD_ASSERT(DT_NODE_HAS_PROP(DT_NODELABEL(charge_status), stat1), "Node 'charge_status.stat1' not found.");
BUILD_ASSERT(DT_NODE_HAS_PROP(DT_NODELABEL(charge_status), stat2), "Node 'charge_status.stat2' not found.");
...
static const struct gpio_dt_spec stat1_pin = GPIO_DT_SPEC_GET(DT_NODELABEL(charge_status), stat1);
static const struct gpio_dt_spec stat2_pin = GPIO_DT_SPEC_GET(DT_NODELABEL(charge_status), stat2);
